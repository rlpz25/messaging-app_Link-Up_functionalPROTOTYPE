...
class AgregarParticipante extends StatefulWidget {
  @override
  _AgregarParticipanteState createState() => _AgregarParticipanteState();
}

class _AgregarParticipanteState extends State<AgregarParticipante> {
                    ...
                    if(distintivo == Constants.miDistintivo){
                      ...
                      if(Constants.participantes.contains(distintivo)){
                        ...
                        return GestureDetector(
                          ...
                          onTap: (){
                            setState(() {
                              Constants.participantes.add(snapshot.data.docs[index].get('distintivo'));
                            });
                          },
                        );
                      }
